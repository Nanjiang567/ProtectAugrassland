...
class Premium_Google_Reviews extends Widget_Base {
    ...
    protected function _register_controls() {
       ...
       $this->add_control('language_prefix',
        ...
        $this->add_control('doc_1',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s Getting your API Key » %2$s', 'premium-addons-pro' ), '<a href="https://premiumaddons.com/docs/getting-your-api-key-for-google-reviews/?utm_source=papro-dashboard&utm_medium=papro-editor&utm_campaign=papro-plugin" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
        ...
        $this->add_control('doc_2',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s How to get your place ID » %2$s', 'premium-addons-pro' ), '<a href="https://premiumaddons.com/docs/how-to-get-google-place-id/?utm_source=papro-dashboard&utm_medium=papro-editor&utm_campaign=papro-plugin" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
        ...
        $this->add_control('doc_3',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s Check the video tutorial » %2$s', 'premium-addons-pro' ), '<a href="https://www.youtube.com/watch?v=Z0EeGyD34Zk" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
        ...
        $this->start_controls_section('readmore',
            [
    ...
    protected function render() {
        ...
        $transient_name = 'papro_reviews_' . $place_id;
        ...
        if ( false === $response ) {
            ...
            $expire_time = transient_expire( $transient );

			$expire_time = apply_filters( 'papro_reviews_expire_time', $expire_time, $settings );
