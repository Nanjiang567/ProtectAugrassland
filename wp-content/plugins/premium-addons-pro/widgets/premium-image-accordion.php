    ...
    protected function _register_controls(){
        ...
        $this->add_control('image_content',
            [
                ...
                'fields' => array_values( $accordion_repeater->get_controls() ),
        ...
        $this->add_control('icon_hover_color',
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .premium-accordion-section .premium-accordion-icon:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control('icon_background_color',
            [
                ...
                'type'          => Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .premium-accordion-section .premium-accordion-icon' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control('icon_background_hover_color',
            [
                ...
                'type'          => Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .premium-accordion-section .premium-accordion-icon:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control('icon_size',
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .premium-accordion-section .premium-accordion-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .premium-accordion-content svg'    => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}'
                ]
            ]
        );
