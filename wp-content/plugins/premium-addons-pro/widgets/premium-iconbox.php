        ...
        $this->add_responsive_control('prmium_icon_box_font_size',
            [
                ...
                'selectors'     => [
                    ...
                    '{{WRAPPER}} .premium-icon-box-icon-container svg' => 'width: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}}',
                ],
                'condition'     => [
                    'premium_icon_box_selector'         => 'font-awesome-icon'
                ]
        ...
        <div class="premium-icon-box-content-outer-wrap">
            ...
            <?php if( 'yes' == $settings['premium_icon_box_link_switcher']  && ( $settings['premium_icon_box_link_text_switcher'] == 'yes' || $settings['premium_icon_box_link_icon_switcher'] == 'yes' ) ) : ?>
                    <div class="premium-icon-box-more">
                        <a class="premium-icon-box-link" <?php if( ! empty( $icon_box_url ) ) : ?> href="<?php echo esc_url( $icon_box_url ); ?>"<?php endif;?><?php if( ! empty( $settings['premium_icon_box_link']['is_external'] ) ) : ?> target="_blank" <?php endif; ?><?php if( !empty($settings['premium_icon_box_link']['nofollow'] ) ) : ?> rel="nofollow" <?php endif; ?>>
