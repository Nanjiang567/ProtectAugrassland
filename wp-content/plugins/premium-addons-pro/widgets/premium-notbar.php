...
class Premium_Notbar extends Widget_Base
{
    ...
    protected function render() {
        ...
        if( $settings['premium_notbar_icon_selector'] === 'font-awesome-icon' ) {
                ...
                <div class="premium-notbar-icon-text-container">
                    <?php if($settings['premium_notbar_icon_switcher'] == 'yes' && $settings['premium_notbar_content_type'] == 'editor' ) : ?>
                        <div class="premium-notbar-icon-wrap">
                            <?php if( $settings['premium_notbar_icon_selector'] === 'font-awesome-icon' ) :
                                if ( $is_new || $migrated ) :
                    ...
                    <?php elseif ($settings['premium_notbar_content_type'] == 'template') : echo $this->getTemplateInstance()->get_template_content( $template ); endif; ?>
                </div>
