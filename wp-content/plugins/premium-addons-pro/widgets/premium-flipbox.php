    ...
    protected function _register_controls() { 
        ...
        $this->add_control('premium_flip_icon_size',
            [
                ...
                'selectors'     => [
                    ...
                    '{{WRAPPER}} .premium-flip-text-wrapper svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}',
                ],
                'condition'     => [
                    'premium_flip_icon_fa_switcher' => 'yes',
                    'premium_flip_icon_selection'   => 'icon'
        ...
        $this->add_control('premium_flip_back_icon_size',
            [
                ...
                'selectors'     => [
                    ...
                    '{{WRAPPER}} .premium-flip-back-text-wrapper svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}',
                ],
                'condition'     => [
                    'premium_flip_back_icon_fa_switcher'    => 'yes',
                    'premium_flip_back_icon_selection'      => 'icon'
        ...
        $this->add_control('premium_flip_border_radius_hover',
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .premium-flip-main-box .premium-flip-back'  => 'border-radius: {{SIZE}}{{UNIT}};',
                ]
            ]
        );
                    ...
                    <div class="premium-flip-front-content">
                        <div class="premium-flip-text-wrapper">
                            <?php if( 'yes' == $settings['premium_flip_icon_fa_switcher'] &&  'icon' == $settings['premium_flip_icon_selection'] ) :
                                ...
                                <?php endif;
                            elseif( 'yes' == $settings['premium_flip_icon_fa_switcher'] && 'image' == $settings['premium_flip_icon_selection'] ) : ?>
            ...
            <div class="premium-flip-back-overlay">
                <div class="premium-flip-back-content-container">
                    <?php if( 'yes' == $settings['premium_flip_back_link_switcher'] && 'full' == $trigger ) : ?>
                        <a class="premium-flip-box-full-link" <?php if( ! empty( $button_url ) ) : ?> href="<?php echo esc_url( $button_url ); ?>"<?php endif;?><?php if( ! empty( $settings['premium_flip_back_link']['is_external'] ) ) : ?> target="_blank"<?php endif; ?><?php if( !empty( $settings['premium_flip_back_link']['nofollow'] ) ) : ?> rel="nofollow" <?php endif; ?>></a>
                    <?php endif; ?>
                    <div class="premium-flip-back-content">
                        <div class="premium-flip-back-text-wrapper">
                            ...
                            <?php endif;
                            elseif( 'yes' == $settings['premium_flip_back_icon_fa_switcher'] && 'image' == $settings['premium_flip_back_icon_selection'] ) : ?>
