    ...
    protected function _register_controls() {
        ...
        $repeater->add_responsive_control('premium_image_hotspots_icon_size',
	        [
                ...
                'selectors'     => [
                    ...
                    '{{WRAPPER}} {{CURRENT_ITEM}} img.premium-image-hotspots-image-icon'    => 'width:{{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}'
                ],
                'condition'     => [
                    'premium_image_hotspots_icon_type_switch!' => 'text'
                ]
        ...
        $repeater->add_control('premium_image_hotspots_icon_backcolor',
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} i.premium-image-hotspots-icon, {{WRAPPER}} {{CURRENT_ITEM}} p.premium-image-hotspots-text, {{WRAPPER}} {{CURRENT_ITEM}} img.premium-image-hotspots-image-icon' => 'background-color: {{VALUE}}',
				]
			]
		);
        ...
        $repeater->add_group_control(
            ...
            [
                ...
                'selector'      => '{{WRAPPER}} {{CURRENT_ITEM}} i.premium-image-hotspots-icon, {{WRAPPER}} {{CURRENT_ITEM}} p.premium-image-hotspots-text, {{WRAPPER}} {{CURRENT_ITEM}} img.premium-image-hotspots-image-icon'
            ]
        );
        ...
        $repeater->add_control('premium_image_hotspots_icon_radius',
            [
                ...
                'size_units'    => ['px', 'em' , '%'],
                'selectors'     => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} i.premium-image-hotspots-icon, {{WRAPPER}} {{CURRENT_ITEM}} p.premium-image-hotspots-text, {{WRAPPER}} {{CURRENT_ITEM}} img.premium-image-hotspots-image-icon' => 'border-radius: {{SIZE}}{{UNIT}};'
                ]
            ]
        );
        ...
        $this->add_control('premium_image_hotspots_icons',
            [
                ...
                'title_field'   => 'Hotspot: <# if ( "font_awesome_icon" === premium_image_hotspots_icon_type_switch ) { #> <i class="{{premium_image_hotspots_font_awesome_icon}}" aria-hidden="true"></i><#} else if( "text" === premium_image_hotspots_icon_type_switch ) { #> {{premium_image_hotspots_text}} <# } else {#> <img class="editor-pa-img" src="{{premium_image_hotspots_custom_image.url}}"><# } #>'
            ]
        );
