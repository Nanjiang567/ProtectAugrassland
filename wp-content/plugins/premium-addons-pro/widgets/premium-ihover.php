...
class Premium_Ihover extends Widget_Base {
    ...
    protected function _register_controls(){
        ...
        $this->add_control('premium_ihover_link_whole',
            [
                'label'         => __( 'Whole Box Link', 'premium-addons-for-elementor' ),
                'type'          => Controls_Manager::SWITCHER,
                'default'       => 'yes',
                'condition'     => [
                    'premium_ihover_thumbnail_link_switcher' => 'yes',
        ...
        $this->add_control('premium_ihover_btn_hover_scale',
            [
                'label'         => __( 'Hover Grow Effect', 'premium-addons-for-elementor' ),
                'type'          => Controls_Manager::SWITCHER,
        ...
        $this->add_group_control(
            ...
            [
                'name'          => 'button_typo',
                'selector'      => '{{WRAPPER}} .premium-ihover-item-link',
            ]
        );
        ...
        $this->add_control('premium_ihover_btn_color',
                [
                    ...
                    'selectors'     => [
                        '{{WRAPPER}} .premium-ihover-item-link'  => 'color: {{VALUE}};'
                        ]
                    ]
                );
        ...
        $this->add_control('premium_ihover_btn_hover_color',
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .premium-ihover-item-link:hover'  => 'color: {{VALUE}};'
                    ]
                ]
            );
        ...
        $this->add_control('premium_ihover_btn_background',
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .premium-ihover-item-link'  => 'background-color: {{VALUE}};'
                    ]
                ]
            );
        ...
        $this->add_control('premium_ihover_btn_hover_background',
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .premium-ihover-item-link:hover'  => 'background-color: {{VALUE}};'
                ]
            ]
        );
        ...
        $this->add_control('premium_ihover_btn_radius',
            [
                ...
                'size_units'    => ['px', 'em', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .premium-ihover-item-link' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}'
                ]
            ]
        );
        ...
        $this->add_responsive_control('premium_ihover_btn_padding',
                [
                    ...
                    'size_units'    => ['px', 'em', '%'],
                    'selectors'     => [
                        '{{WRAPPER}} .premium-ihover-item-link' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                    ]
                ]);
                                ...
                                <div class="premium-ihover-content">
                                    <div class="premium-ihover-content-wrap">
                                        <div class="premium-ihover-title-wrap">
                                            ...
                                            <?php endif;
                                            elseif( 'yes' == $settings['premium_ihover_icon_fa_switcher'] && 'image' == $settings['premium_ihover_icon_selection'] ) : ?>
                            ...
                            <div class="premium-ihover-info-back">
                                <div class="premium-ihover-content">
                                    <div class="premium-ihover-content-wrap">
                                        ...
                                        <# if ( 'yes' !== settings.premium_ihover_link_whole && 'yes' === settings.premium_ihover_thumbnail_link_switcher ) { #>
                                            <div class="premium-ihover-btn-container">
                                                <a class="premium-ihover-item-link" href="{{ linkUrl }}" title="{{ settings.premium_ihover_thumbnail_link_text }}">{{{settings.premium_ihover_button_text}}}</a>
                                            </div>
                                        <# } #>
