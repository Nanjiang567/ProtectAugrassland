...
if( ! defined( 'ABSPATH' ) ) exit;
 ...
 class Premium_Yelp_Reviews extends Widget_Base {
    ...
    public function get_custom_help_url() {
		return 'https://youtu.be/5T-MveVFvns';
	}
    
    // Adding the controls fields for the Premium Yelp Reviews
     ...
     protected function _register_controls() {
        ...
        $this->add_control('limit_num',
            [
                ...
                'min'           => 0,
                'max'           => 3,
                'description'   => __('You can only pull 5 reviews from Yelp', 'premium-addons-pro'),
                'condition'     => [
                    'limit' => 'yes'
                ],
            ]
    ...
    protected function render() {
        ...
        $reviews_transient = 'papro_reviews_' . $place_id;
        
        $place_transient = 'papro_reviews_place_' . $place_id;
