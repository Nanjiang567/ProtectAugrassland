! function(e) {
    ...
    var i = function(e, i) {
        ...
        var n = this.pJS;
        i && Object.deepExtend(n, i), n.tmp.obj = {
            ...
            if (this.radius = (n.particles.size.random ? Math.random() : 1) * n.particles.size.value, n.particles.size.anim.enable && (this.size_status = !1, this.vs = n.particles.size.anim.speed / 100, n.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = i ? i.x : Math.random() * n.canvas.w, this.y = i ? i.y : Math.random() * n.canvas.h, this.x > n.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > n.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), n.particles.move.bounce && n.fn.vendors.checkOverlap(this, i), this.color = {}, "object" == typeof e.value)
                if (e.value instanceof Array) {
                    var s = e.value[Math.floor(Math.random() * n.particles.color.value.length)];
                    this.color.rgb = t(s)
            ...
            } : "string" == typeof e.value && (this.color = e, this.color.rgb = t(this.color.value));
            ...
            switch (n.canvas.ctx.fillStyle = i, n.canvas.ctx.beginPath(), e.shape) {
                case "circle":
                ...
                case "image":
                    ...
                    else s = n.tmp.img_obj;
                    s && n.canvas.ctx.drawImage(s, e.x - t, e.y - t, 2 * t, 2 * t / e.img.ratio)
            }
            ...
            for (var e = 0; e < n.particles.array.length; e++) {
                ...
                if (n.particles.opacity.anim.enable && (1 == t.opacity_status ? (t.opacity >= n.particles.opacity.value && (t.opacity_status = !1), t.opacity += t.vo) : (t.opacity <= n.particles.opacity.anim.opacity_min && (t.opacity_status = !0), t.opacity -= t.vo), t.opacity < 0 && (t.opacity = 0)), n.particles.size.anim.enable && (1 == t.size_status ? (t.radius >= n.particles.size.value && (t.size_status = !1), t.radius += t.vs) : (t.radius <= n.particles.size.anim.size_min && (t.size_status = !0), t.radius -= t.vs), t.radius < 0 && (t.radius = 0)), "bounce" == n.particles.move.out_mode) var s = {
                    x_left: t.radius,
                    x_right: n.canvas.w,
                    y_top: t.radius,
                    y_bottom: n.canvas.h
                ...
                switch (t.x - t.radius > n.canvas.w ? (t.x = s.x_left, t.y = Math.random() * n.canvas.h) : t.x + t.radius < 0 && (t.x = s.x_right, t.y = Math.random() * n.canvas.h), t.y - t.radius > n.canvas.h ? (t.y = s.y_top, t.x = Math.random() * n.canvas.w) : t.y + t.radius < 0 && (t.y = s.y_bottom, t.x = Math.random() * n.canvas.w), n.particles.move.out_mode) {
                    case "bounce":
                        t.x + t.radius > n.canvas.w ? t.vx = -t.vx : t.x - t.radius < 0 && (t.vx = -t.vx), t.y + t.radius > n.canvas.h ? t.vy = -t.vy : t.y - t.radius < 0 && (t.vy = -t.vy)
                }
                if (a("grab", n.interactivity.events.onhover.mode) && n.fn.modes.grabParticle(t), (a("bubble", n.interactivity.events.onhover.mode) || a("bubble", n.interactivity.events.onclick.mode)) && n.fn.modes.bubbleParticle(t), (a("repulse", n.interactivity.events.onhover.mode) || a("repulse", n.interactivity.events.onclick.mode)) && n.fn.modes.repulseParticle(t), n.particles.line_linked.enable || n.particles.move.attract.enable)
                    for (var r = e + 1; r < n.particles.array.length; r++) {
                        var c = n.particles.array[r];
                        n.particles.line_linked.enable && n.fn.interact.linkParticles(t, c), n.particles.move.attract.enable && n.fn.interact.attractParticles(t, c), n.particles.move.bounce && n.fn.interact.bounceParticles(t, c)
                    }
            }
            ...
            if (s <= n.particles.line_linked.distance) {
                ...
                if (r > 0) {
                    ...
                    n.canvas.ctx.strokeStyle = "rgba(" + c.r + "," + c.g + "," + c.b + "," + r + ")", n.canvas.ctx.lineWidth = n.particles.line_linked.width, n.canvas.ctx.beginPath(), n.canvas.ctx.moveTo(e.x, e.y), n.canvas.ctx.lineTo(t.x, t.y), n.canvas.ctx.stroke(), n.canvas.ctx.closePath()
                }
            }
            ...
            if (Math.sqrt(a * a + i * i) <= n.particles.line_linked.distance) {
                var s = a / (1e3 * n.particles.move.attract.rotateX),
            ...
            n.tmp.pushing = !0;
            for (var a = 0; e > a; a++) n.particles.array.push(new n.fn.particle(n.particles.color, n.particles.opacity.value, {
                x: t ? t.pos_x : Math.random() * n.canvas.w,
                y: t ? t.pos_y : Math.random() * n.canvas.h
            })), a == e - 1 && (n.particles.move.enable || n.fn.particlesDraw(), n.tmp.pushing = !1)
            ...
            function i(t, a, i, s, r) {
                if (t != a)
                    if (n.tmp.bubble_duration_end) {
                        if (null != i) o = t + (t - (s - d * (s - t) / n.interactivity.modes.bubble.duration)), "size" == r && (e.radius_bubble = o), "opacity" == r && (e.opacity_bubble = o)
                    } else if (p <= n.interactivity.modes.bubble.distance) {
                    if (null != i) var c = i;
                    else c = s;
                    if (c != t) {
                        var o = s - d * (s - t) / n.interactivity.modes.bubble.duration;
            ...
            if (n.interactivity.events.onhover.enable && a("bubble", n.interactivity.events.onhover.mode)) {
                var s = e.x - n.interactivity.mouse.pos_x,
                    r = e.y - n.interactivity.mouse.pos_y,
                    c = 1 - (p = Math.sqrt(s * s + r * r)) / n.interactivity.modes.bubble.distance;
                if (p <= n.interactivity.modes.bubble.distance) {
                    if (c >= 0 && "mousemove" == n.interactivity.status) {
                        if (n.interactivity.modes.bubble.size != n.particles.size.value)
                            if (n.interactivity.modes.bubble.size > n.particles.size.value) {
                                (l = e.radius + n.interactivity.modes.bubble.size * c) >= 0 && (e.radius_bubble = l)
                            } else {
                            ...
                            if (n.interactivity.modes.bubble.opacity > n.particles.opacity.value) {
                                (v = n.interactivity.modes.bubble.opacity * c) > e.opacity && v <= n.interactivity.modes.bubble.opacity && (e.opacity_bubble = v)
                            } else {
                                var v;
                                (v = e.opacity - (n.particles.opacity.value - n.interactivity.modes.bubble.opacity) * c) < e.opacity && v >= n.interactivity.modes.bubble.opacity && (e.opacity_bubble = v)
                            }
                    }
                } else t();
                ...
                if (n.tmp.bubble_clicking) {
                    s = e.x - n.interactivity.mouse.click_pos_x, r = e.y - n.interactivity.mouse.click_pos_y;
                    var p = Math.sqrt(s * s + r * r),
                ...
                n.tmp.bubble_clicking && (i(n.interactivity.modes.bubble.size, n.particles.size.value, e.radius_bubble, e.radius, "size"), i(n.interactivity.modes.bubble.opacity, n.particles.opacity.value, e.opacity_bubble, e.opacity, "opacity"))
            }
            ...
            if (n.interactivity.events.onhover.enable && a("repulse", n.interactivity.events.onhover.mode) && "mousemove" == n.interactivity.status) {
                var t = e.x - n.interactivity.mouse.pos_x,
                    ...
                    }(1 / (l = n.interactivity.modes.repulse.distance) * (-1 * Math.pow(s / l, 2) + 1) * l * 100, 0, 50),
                    o = {
                        x: e.x + r.x * c,
                        y: e.y + r.y * c
                    };
                "bounce" == n.particles.move.out_mode ? (o.x - e.radius > 0 && o.x + e.radius < n.canvas.w && (e.x = o.x), o.y - e.radius > 0 && o.y + e.radius < n.canvas.h && (e.y = o.y)) : (e.x = o.x, e.y = o.y)
                ...
                if (n.tmp.repulse_finish || (n.tmp.repulse_count++, n.tmp.repulse_count == n.particles.array.length && (n.tmp.repulse_finish = !0)), n.tmp.repulse_clicking) {
                    var l = Math.pow(n.interactivity.modes.repulse.distance / 6, 3),
                        v = n.interactivity.mouse.click_pos_x - e.x,
                        p = n.interactivity.mouse.click_pos_y - e.y,
                        d = v * v + p * p,
                        m = -l / d * 1;
                    l >= d && function() {
                        var t = Math.atan2(p, v);
                        if (e.vx = m * Math.cos(t), e.vy = m * Math.sin(t), "bounce" == n.particles.move.out_mode) {
                            var a = {
                                x: e.x + e.vx,
                                y: e.y + e.vy
                            };
                            a.x + e.radius > n.canvas.w ? e.vx = -e.vx : a.x - e.radius < 0 && (e.vx = -e.vx), a.y + e.radius > n.canvas.h ? e.vy = -e.vy : a.y - e.radius < 0 && (e.vy = -e.vy)
                        }
                    }()
            ...
            if (n.interactivity.events.onhover.enable && "mousemove" == n.interactivity.status) {
                ...
                if (i <= n.interactivity.modes.grab.distance) {
                    ...
                    if (s > 0) {
                        ...
                        n.canvas.ctx.strokeStyle = "rgba(" + r.r + "," + r.g + "," + r.b + "," + s + ")", n.canvas.ctx.lineWidth = n.particles.line_linked.width, n.canvas.ctx.beginPath(), n.canvas.ctx.moveTo(e.x, e.y), n.canvas.ctx.lineTo(n.interactivity.mouse.pos_x, n.interactivity.mouse.pos_y), n.canvas.ctx.stroke(), n.canvas.ctx.closePath()
                    }
                }
            }
            ...
            "window" == n.interactivity.detect_on ? n.interactivity.el = window : n.interactivity.el = n.canvas.el, (n.interactivity.events.onhover.enable || n.interactivity.events.onclick.enable) && (n.interactivity.el.addEventListener("mousemove", function(e) {
                ...
                n.interactivity.mouse.pos_x = t, n.interactivity.mouse.pos_y = a, n.tmp.retina && (n.interactivity.mouse.pos_x *= n.canvas.pxratio, n.interactivity.mouse.pos_y *= n.canvas.pxratio), n.interactivity.status = "mousemove"
            ...
            if (n.particles.number.density.enable) {
                ...
                0 > a ? n.fn.modes.pushParticles(Math.abs(a)) : n.fn.modes.removeParticles(a)
            }
            ...
            for (var a = 0; a < n.particles.array.length; a++) {
                var i = n.particles.array[a],
                    s = e.x - i.x,
                    r = e.y - i.y;
                Math.sqrt(s * s + r * r) <= e.radius + i.radius && (e.x = t ? t.x : Math.random() * n.canvas.w, e.y = t ? t.y : Math.random() * n.canvas.h, n.fn.vendors.checkOverlap(e))
            }
        }, n.fn.vendors.createSvgImg = function(e) {
            var t = n.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, function(t, a, i, s) {
            ...
            r.addEventListener("load", function() {
                e.img.obj = r, e.img.loaded = !0, i.revokeObjectURL(s), n.tmp.count_svg++
            }), r.src = s
        }, n.fn.vendors.destroypJS = function() {
            cancelAnimationFrame(n.fn.drawAnimFrame), s.remove(), pJSDom = null
        }, n.fn.vendors.drawShape = function(e, t, a, i, s, n) {
            var r = s * n,
                c = s / n,
                o = 180 * (c - 2) / c,
            ...
            if (n.tmp.img_error = void 0, "" != n.particles.shape.image.src)
                if ("svg" == e) {
                    ...
                    a.addEventListener("load", function() {
                        n.tmp.img_obj = a, n.fn.vendors.checkBeforeDraw()
            ...
            n.fn.retinaInit(), n.fn.canvasInit(), n.fn.canvasSize(), n.fn.canvasPaint(), n.fn.particlesCreate(), n.fn.vendors.densityAutoParticles(), n.particles.line_linked.color_rgb_line = t(n.particles.line_linked.color)
        }, n.fn.vendors.start = function() {
            a("image", n.particles.shape.type) ? (n.tmp.img_type = n.particles.shape.image.src.substr(n.particles.shape.image.src.length - 3), n.fn.vendors.loadImg(n.tmp.img_type)) : n.fn.vendors.checkBeforeDraw()
    ...
    Object.deepExtend = function(e, t) {
        ...
        var a = document.getElementById(e),
            ...
            n = a.getElementsByClassName(s);
        if (n.length)
            for (; n.length > 0;) a.removeChild(n[0]);
        var r = document.createElement("canvas");
        r.className = s, r.style.width = "100%", r.style.height = "100%", null != document.getElementById(e).appendChild(r) && pJSDom.push(new i(e, t))
    ...
    }, e(".premium-particles-yes").length && Object.keys(window.scopes_array).forEach(function(t) {
        $scope = window.scopes_array[t],
            function(t) {
                var a = t,
                    i = a.data("id"),
                    s = {};
                ...
                a.attr("id", "premium-section-particles-" + i), particlesJS("premium-section-particles-" + i, s.style), a.children("canvas.particles-js-canvas-el").css({
                    zIndex: s.zindex
                })
            }($scope)
    })
