                ...
                facebook: {
                    ...
                    utility: {
                        ...
                        unifyPostData: function(t) {
                            ...
                            if (e.id = t.id, e.dt_create = l.getTimeAgo(t.created_time), e.author_link = "http://facebook.com/" + t.from.id, e.author_picture = l.facebook.graph + t.from.id + "/picture", e.author_name = t.from.name, e.name = t.name || "", e.message = a || "", e.description = t.description ? t.description : "", e.link = t.link ? t.link : "http://facebook.com/" + t.id, !0 === i.show_media && t.full_picture) {
