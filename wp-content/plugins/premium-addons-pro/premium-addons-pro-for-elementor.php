...
Description: Premium Addons PRO Plugin Includes 29+ premium widgets & addons for Elementor Page Builder.
...
define( 'PREMIUM_PRO_ADDONS_VERSION', '1.8.5' );
define( 'PREMIUM_PRO_ADDONS_STABLE_VERSION', '1.8.4' );
